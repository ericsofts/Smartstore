    ...
    public class LinkedInHandler : OAuthHandler<LinkedInOptions>
    {
            ...
            OAuthTokenResponse tokens)
        {
            ...
            var fields = Options.Fields
                .Where(f => !string.Equals(f, LinkedInConstants.EmailAddressField, StringComparison.OrdinalIgnoreCase))
                .ToList();
            ...
            if (!string.IsNullOrEmpty(Options.EmailAddressEndpoint) &&
                Options.Fields.Contains(LinkedInConstants.EmailAddressField))
            {
